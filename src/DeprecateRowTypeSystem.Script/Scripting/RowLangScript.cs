...
using System.Linq;
using System.Text;
using RowTypeSystem.Core.Syntax;
using RowTypeSystem.Core.Runtime;
using RowTypeSystem.Core.Types;

namespace RowTypeSystem.Core.Scripting;
...
public sealed class RowLangModule
{
    ...
    public RowTypeSystem.Core.Runtime.ExecutionContext CreateExecutionContext() => new RowTypeSystem.Core.Runtime.ExecutionContext(_typeSystem);

    public IEnumerable<(RunDirective Directive, Value Result)> ExecuteRuns(RowTypeSystem.Core.Runtime.ExecutionContext context)
    {
