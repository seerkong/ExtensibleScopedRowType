...
/// <summary>
/// Lambda function wrapper for KsNode system
/// </summary>
public class KsLambdaFunction : KsValueNode
{
    /// <summary>
    ...
    public KsLambdaFunction(LambdaFunction function)
    {
        Function = function;
    }
    ...
    public override bool Equals(object? obj) => obj is KsLambdaFunction other && Function.Equals(other.Function);
...
public class LambdaFunction
{
    ...
    /// </summary>
    public KsArray Body { get; }

    /// <summary>
    /// The environment in which the function was defined
    /// </summary>
    public Runtime.Env DefinitionEnvironment { get; }
    ...
    public LambdaFunction(string name, string[] parameters, KsArray body, Runtime.Env definitionEnvironment)
    {
        Name = name;
