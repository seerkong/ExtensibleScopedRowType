...
public static class EnvHandler
{
    ...
    public static void RunDiveProcessEnv(KsonInterpreterRuntime runtime, Instruction instruction)
    {
    ...
    public static Env MakeSubLocalEnvUnderEnv(
        KsonInterpreterRuntime runtime,
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunDiveLocalEnv(KsonInterpreterRuntime runtime, Instruction instruction)
    {
        var currentEnv = runtime.GetCurEnv();
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunRise(KsonInterpreterRuntime runtime, Instruction instruction)
    {
        var currentEnv = runtime.GetCurEnv();
        var nextEnvs = runtime.EnvTree.GetNextVertexDetails(currentEnv.GetVertexId());

        if (nextEnvs.Count > 0)
        {
            var nextEnv = nextEnvs[0];
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunChangeEnvById(KsonInterpreterRuntime runtime, Instruction instruction)
    {
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunDeclareGlobalVar(KsonInterpreterRuntime runtime, Instruction instruction)
    {
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunDeclareLocalVar(KsonInterpreterRuntime runtime, Instruction instruction)
    {
        var name = (string)instruction.Memo;
        var value = runtime.GetCurrentFiber().OperandStack.PopValue();
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunSetGlobalEnv(KsonInterpreterRuntime runtime, Instruction instruction)
    {
        var name = (string)instruction.Memo;
        var value = runtime.GetCurrentFiber().OperandStack.PopValue();
        runtime.GetGlobalEnv().Define(name, value);
    ...
    /// <param name="state">The interpreter state</param>
    /// <param name="instruction">The instruction</param>
    public static void RunSetLocalEnv(KsonInterpreterRuntime runtime, Instruction instruction)
    {
        var name = (string)instruction.Memo;
        var value = runtime.GetCurrentFiber().OperandStack.PopValue();
    ...
    public static void RunBindEnvByMap(KsonInterpreterRuntime runtime, Instruction opContState)
    {
        ...
        if (lastVal is Dictionary<string, KsNode> dict)
        {
